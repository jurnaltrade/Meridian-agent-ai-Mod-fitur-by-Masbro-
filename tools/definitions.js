...
Blacklisted tokens are filtered BEFORE the LLM even sees pool candidates.`,
  ...
  // ═══════════════════════════════════════════
  {
    ...
    function: {
      ...
      description: "Classify current volatility regime (LOW/MEDIUM/HIGH/EXTREME) for a pool and get a concrete bins_below/bins_above/strategy/position_size_multiplier recommendation. Call this BEFORE deploy_position to adapt the range to current conditions instead of using static defaults.",
      parameters: {
        type: "object",
        properties: {
          pool_address: { type: "string", description: "Pool address to analyze." },
          timeframe: { type: "string", description: "Optional timeframe override, e.g. '5m', '1h'." },
        },
        required: ["pool_address"],
      },
    },
  },
  {
    type: "function",
    function: {
      name: "pick_bandit_arm",
      description: "Ask the multi-armed bandit allocator which strategy preset (arm) to use for the next deploy, based on historical win-rate/PnL per arm via Thompson Sampling. Returns bins_below/bins_above/strategy/position_size_multiplier and an arm_id — tag the deployed position with arm_id (e.g. via set_position_note) so record outcomes can be attributed correctly when it closes.",
      parameters: {
        type: "object",
        properties: {}
      },
  ...
  },
  {
    type: "function",
    function: {
      name: "get_bandit_summary",
      description: "Get current performance stats and posterior win-rate estimate for every bandit arm.",
      parameters: {
        type: "object",
        properties: {}
      },
  ...
  },
  {
    type: "function",
    function: {
      name: "scan_whale_activity",
      description: "Snapshot all tracked smart-money wallets' LP positions, diff against the last snapshot, and flag any whale exits/re-ranges/entries in pools Meridian currently has open positions in. Call this once per management cycle.",
      parameters: {
        type: "object",
        properties: {}
      },
  ...
  },
  {
    type: "function",
    function: {
      name: "get_whale_signal_for_pool",
      description: "Get recent tracked-whale activity (entries/exits/re-ranges) for a specific pool over a time window, with a net-flow signal.",
      parameters: {
        type: "object",
        properties: {
          pool_address: { type: "string" },
          hours: { type: "number", description: "Lookback window in hours. Default 12." },
        },
        required: ["pool_address"],
      },
    },
  },
  {
    ...
    function: {
      ...
      description: "Get the current profit-insurance buffer balance and recent contribution/withdrawal history.",
      parameters: {
        type: "object",
        properties: {}
      },
  ...
  },
  {
    type: "function",
    function: {
      name: "insurance_withdraw",
      description: "Withdraw from the profit-insurance buffer (e.g. to cushion a stop-loss or top up gas reserve). Reduces the tracked buffer balance.",
      parameters: {
        type: "object",
        properties: {
  ...
  },
  {
    ...
    function: {
      ...
      description: "Compute aggregate delta (net directional exposure) and gamma (concentration/range-tightness risk) across ALL currently open DLMM positions. Use this instead of judging positions one-by-one when deciding whether to hedge or diversify new deploys.",
      parameters: {
        type: "object",
        properties: {}
      },
  ...
  },
  {
    type: "function",
    function: {
      name: "get_portfolio_hedge_sizing",
      description: "Get a suggested single portfolio-level hedge notional/direction based on current aggregate delta exposure — more capital-efficient than hedging each position individually.",
      parameters: {
        type: "object",
        properties: {}
      },
  ...
  },
  {
    type: "function",
    function: {
      name: "register_jit_watch",
      description: "Start tracking a pool's rolling volume baseline for JIT burst detection.",
      parameters: {
        type: "object",
        properties: {
          pool_address: { type: "string" },
  ...
  },
  {
    type: "function",
    function: {
      name: "check_jit_opportunity",
      description: "Check a watched pool for a volume burst; if detected and JIT is enabled, deploys a tight rapid-response LP position automatically.",
      parameters: {
        type: "object",
        properties: {
          pool_address: { type: "string" },
  ...
  },
  {
    type: "function",
    function: {
      name: "close_expired_jit_sessions",
      description: "Force-close any rapid JIT LP sessions that have passed their hold window. Call on the same timer as check_jit_opportunity.",
      parameters: {
        type: "object",
        properties: {}
      },
  ...
  },
  {
    type: "function",
    function: {
      name: "get_jit_summary",
      description: "Get JIT liquidity session stats: win rate, total PnL, open/closed sessions.",
      parameters: {
        type: "object",
        properties: {}
      },
